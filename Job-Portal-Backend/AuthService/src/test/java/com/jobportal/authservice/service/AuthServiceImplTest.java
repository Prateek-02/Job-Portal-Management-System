...
class AuthServiceImplTest {
    ...
    void getUserById_Success() {
        // Arrange
        com.jobportal.authservice.dto.response.UserResponse userResponse =
                new com.jobportal.authservice.dto.response.UserResponse();
        ...
        // Act
        com.jobportal.authservice.dto.response.UserResponse response =
    ...
    void updateProfile_Success() {
        // Arrange
        com.jobportal.authservice.dto.request.UpdateProfileRequest updateRequest =
                new com.jobportal.authservice.dto.request.UpdateProfileRequest();
        ...
        // Act
        com.jobportal.authservice.dto.response.UserResponse response =
                authService.updateProfile(1L, updateRequest);
    ...
    void getAllUsers_Success() {
        ...
        // Act
        java.util.List<com.jobportal.authservice.dto.response.UserResponse> response =
