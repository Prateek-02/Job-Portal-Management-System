...
public class JobServiceImpl implements JobService {
    ...
    public JobResponseDto createJob(JobRequestDto dto,
        ...
        // Publish Job Posted event to RabbitMQ
        try {
            ...
            System.out.println("Job Posted event published!");
        } catch (Exception e) {
            System.out.println(
                    "Failed to publish job posted event: "
                    + e.getMessage());
        }
    ...
    public JobResponseDto updateJob(Long id,
        ...
        return modelMapper.map(jobRepository.save(job),
                JobResponseDto.class);
    }
